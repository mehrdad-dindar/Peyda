                ...
                <div class="col-md-6">
                    ...
                    <form method="POST" action="{{ route('doLoginPhone') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control  @error('phone_num') is-invalid @enderror" type="text" id="phone_num"  name="phone_num" value="{{ old('phone_num') }}" required autocomplete="phone_num" placeholder="0912XXXXXXX" autofocus>
                            @error('phone_num')
                        ...
                        <div class="form-group d-flex justify-content-between align-items-center mb-3">
                            <div class="checkbox d-inline mb-0">
                                <input type="checkbox" name="remember_me" id="checkbox-8" {{ old('remember_me') ? 'checked' : '' }}>
