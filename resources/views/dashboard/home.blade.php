                        ...
                        <div class="card-body px-3 py-2">
                            <div
                                ...
                                <ul class="downloads--data-btn d-flex align-items-center justify-content-between mb-3 mb-sm-0">
                                    <li><a href="#" class="btn"><i class="ti-arrow-down"></i> بارگیری ها</a>
                                    </li>
                                    <li><a href="#" class="btn"><i class="ti-reload"></i> به روزرسانی ها</a>
                                    </li>
                            ...
                            <div class="client-name">
                                <div class="row">
                                    <div class="col-sm-12 pt-2 pb-2">
                                                <span class="mr-3"><i
                                                        class="feather icon-circle text-c-green  mr-2"></i>کیف پول اصلی </span>
                                    ...
                                    <div class="col-sm-12 pt-2">
                                                <span class="mr-3"><i
                                                        class="feather icon-circle text-c-purple  mr-2"></i>غذا و نوشیدنی </span>
                                        ...
                                        <div class="media">
                                            <div class="mr-3">
                                                ...
                                                <a href="#!"><img class="rounded-circle" style="width:40px;"
                                                                  src="admin/img/member-img/1.png" alt="کاربر چت"></a>
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <div class="single-widget-timeline mb-15">
                                        <div class="media">
                                            <div class="mr-3">
                                                <i class="fa fa-circle text-success font-11 mr-2"></i>
                                                <a href="#!"><img class="rounded-circle" style="width:40px;"
                                                                  src="admin/img/member-img/team-1.jpg"
                                                                  alt="کاربر چت"></a>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="d-inline-block">لورم ایپسوم متن ساختگی </h6>
                                    ...
                                    <div class="single-widget-timeline mb-15">
                                        <div class="media">
                                            <div class="mr-3">
                                                <i class="fa fa-circle text-success font-11 mr-2"></i>
                                                <a href="#!"><img class="rounded-circle" style="width:40px;"
                                                                  src="admin/img/member-img/team-2.jpg"
                                                                  alt="کاربر چت"></a>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="d-inline-block">لورم ایپسوم متن ساختگی </h6>
                                    ...
                                    <div class="single-widget-timeline">
                                        <div class="media">
                                            <div class="mr-3">
                                                <i class="fa fa-circle text-success font-11 mr-2"></i>
                                                <a href="#!"><img class="rounded-circle" style="width:40px;"
                                                                  src="admin/img/member-img/team-4.jpg"
                                                                  alt="کاربر چت"></a>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="d-inline-block">لورم ایپسوم متن ساختگی </h6>
                                        ...
                                        <div class="chat">
                                            ...
                                            <div class="chat-body">
                                                <div class="chat-content">
                                                    <p class="text-white">چطور میتوانیم کمک کنیم؟ ما برای شما
                                                        اینجا هستیم</p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="row mb-3">
                                <div class="col-9">
                                    <div class="progress-wrapper">
                                                <span
                                                    class="progress-label text-dark font-weight-bold">طراحی وب سایت</span>
                            ...
                            <div class="row mb-3">
                                <div class="col-9">
                                    <div class="progress-wrapper">
                                                <span
                                                    class="progress-label text-dark font-weight-bold">الگوی پاسخگو</span>
                                        <div class="progress mt-2 mb-2" style="height: 5px;">
                                            <div class="progress-bar bg-primary" role="progressbar"
                            ...
                            <div class="row mb-3">
                                <div class="col-9">
                                    <div class="progress-wrapper">
                                                <span
                                                    class="progress-label text-dark font-weight-bold">الگوی موبایل</span>
                                        <div class="progress mt-2 mb-2" style="height: 5px;">
                                            <div class="progress-bar bg-primary" role="progressbar"
                            ...
                            <div class="user-card-body">
                                <div class="client-media-content d-flex align-items-center mb-4">
                                    <img class="client-thumb rounded-circle mr-3"
                                         src="admin/img/member-img/contact-1.jpg" alt="">
                                ...
                                <div class="client-media-content d-flex align-items-center mb-4">
                                    <img class="client-thumb rounded-circle mr-3"
                                         src="admin/img/member-img/contact-2.jpg" alt="">
                                    <div class="user--media-body">
                                ...
                                <div class="client-media-content d-flex align-items-center mb-4">
                                    <img class="client-thumb rounded-circle mr-3"
                                         src="admin/img/member-img/contact-3.jpg" alt="">
                                    <div class="user--media-body">
                                ...
                                <div class="client-media-content d-flex align-items-center mb-4">
                                    <img class="client-thumb rounded-circle mr-3"
                                         src="admin/img/member-img/contact-4.jpg" alt="">
                                    <div class="user--media-body">
