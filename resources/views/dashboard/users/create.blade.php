                    ...
                    display: none;
                        ...
                        <div class="row">
                            <div class="col-12 box-margin">
                                <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mb-6">اطلاعات کاربر<button type="button" class="btn" aria-expanded="false"><img src="@if($user->avatar){{URL::asset('uploads/avatars').'/'.$user->avatar}} @else{{ URL::asset('profile/media/avatars/user.jpg') }}@endif" alt=""></button></h5>
                                                ...
                                                <div class="card">
                                                    <div class="card-body pb-0">
                                                        ...
                                                        <div class="row lightgallery">
                                                            <!-- Single Gallery Area -->
                                                            {{--                                                    @foreach($user->)--}}
                                                            <a class="single_gallery_item col-sm-6 col-xl-3 mb-30" @if($user->melli_card!=null) href="{{URL::asset('uploads/melli_cards').'/'.$user->melli_card}}" @endif><img  @if($user->melli_card!=null) src="{{URL::asset('uploads/melli_cards').'/'.$user->melli_card}}" @endif alt=""></a>
                                                            <!-- Single Gallery Area -->
                                                        </div>
                                                    </div>
                                                </div>
