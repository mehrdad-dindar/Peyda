...
@section('content')
    <!-- Hero Start -->
    <section class="bg-half d-table w-100" style="background: url('{{ URL::asset('front/img/shop/faragaranti.jpg')}}') center center;background-size: cover">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 col-md-7">
                    <div class="title-heading mt-4">
                        ...
                        <p class="para-desc text-muted" style="text-align: justify">
                            شرکت پیدا سرویس ماندگار برای حمایت از مشتریان عزیز به ارائه‌ی خدمات فراگارانتی می‌پردازد. جالب است بدانید که این خدمات بدون واسطه و در خود شرکت انجام می‌شود بنابراین شما می‌توانید در کوتاه‌ترین زمان بدون اتلاف وقت و با خیال راحت در امنیت کامل خدمت مورد نیاز خود را دریافت نمایید.
                        </p>
                        <!--<div class="mt-4 pt-2">
                ...
                <div class="col-lg-5 col-md-5 mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <img src="{{URL::asset('main/images/MAIN.png')}}" alt="">
                </div><!--end col-->
            </div><!--end row-->
        </div><!--end container-->
    </section><!--end section-->
    ...
    <div class="row justify-content-center">
        <div class="col-12 text-center">
            <div class="section-title mb-4 pb-2">
                <h4 class="title mb-4">فراگارانتی <a href="" class="" data-bs-toggle="tooltip" data-bs-placement="top" title=" (گوشی همراه، تبلت و لپ‌تاپ)">تجهیزات الکترونیک</a> شرکت  پیدا سرویس </h4>
                ...
                <div class="col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="section-title me-lg-5">
                        ...
                        <p class="text-muted" style="text-align: justify">
                            سرعت زندگی این روزها بسیار زیاد شده است. برای عقب نماندن از حرکت سریع جهان ما هم باید دقت و سرعت عمل‌مان را بالا ببریم. اما ممکن است گاهی در لابه‌لای مشغله و دویدن‌ها گوشی از دست‌هایمان بلغزد و بر زمین بیافتد! اصلا جای نگرانی نیست سرعت‌تان را کاهش ندهید شرکت <span class="text-primary fw-bold">پیدا سرویس ماندگار</span> بدون اتلاف وقت خسارت وارده را جبران می‌کند و در کوتاه‌ترین زمان گوشی تلفن همراه‌تان را تعمیر خواهدکرد.
                        </p>
    ...
    <section class="section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="{{URL::asset('main/images/watered.png')}}" class="me-md-4" alt="">
                </div><!--end col-->
                ...
                <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="section-title ms-lg-5">
                        ...
                        <p class="text-muted" style="text-align: justify">
                            معمولا شرکت‌های سازنده موبایل، حتی برای گوشی‌های ضدآب، زیان‌های وارده از رطوبت‌دیدگی و آب‌خوردگی را پشتیبانی نمی‌کنند پس اگر گوشی همراه شما در اثر تماس با آب دچار آسیب شود، شامل ضوابط گارانتی شرکت طرف قرارداد نیست. بهترین راه جلوگیری از این اتفاق، داشتن فراگارانتی شرکت پیدا سرویس با هزینه قابل قبول سالیانه برای گوشی‌های همراه شما است. با دارا بودن فراگارانتی پیدا سرویس، در صورت خیس شدن تلفن همراه‌تان لازم نیست برای تعمیرات هزینه‌ی اضافی پرداخت نمائید تنها کاری که باید انجام دهید تحویل گوشی سالم از شرکت پیدا سرویس است.
                        </p>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
            ...
            <div class="row align-items-center">
                <div class="col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="section-title me-lg-5">
                        ...
                        <p class="text-muted" style="text-align: justify">
                            برای هر وسیله‌ی برقی امکان وقوع اتصالی وجود دارد. نوسان‌های برقی ممکن است باعث ایجاد مشکل در سیستم‌عامل یا نرم‌افزارهای گوشی همراه شوند و در ادامه‌ی زیان‌های وارده ممکن است مدار محافظ ورودی، شارژر و یا آی‌سی تلفن هم بسوزد. قطع به یقین خرید لوازم، هزینه و وقت زیادی خواهد گرفت. افزون بر این اطمینان از اصل بودن لوازم جایگزین شده هم بسیار سخت است اما شما می‌توانید با خرید فراگارانتی پیدا سرویس میزان خسارت‌های وارده را تا حد امکان کم کنید.
                        </p>
                        <!--<a href="javascript:void(0)" class="btn btn-outline-primary">شروع کنید <i class="uil uil-angle-left-b"></i></a>-->
                    </div>
                </div><!--end col-->
    ...
    <section class="section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="{{URL::asset('main/images/chemical.png')}}" class="me-md-4" alt="">
                </div><!--end col-->
                ...
                <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="section-title ms-lg-5">
                        ...
                        <p class="text-muted" style="text-align: justify">
                            با شیوع روزافزون کرونا استفاده از الکل و مواد شیمیایی جهت ضدعفونی کردن سطوح و گوشی‌های همراه رواج و افزایش پیدا کرده است. خالی از لطف نیست که بدانید مواد ضدعفونی و الکل به درگاه شارژر، هندزفری و همین‌طور اسپیکرها نفوذ می‌کنند و باعث آسیب جدی تلفن خواهند شد. با خرید فراگارانتی پیدا سرویس شما می‌توانید تا 70 درصد خسارت‌های وارده را جبران شده بدانید.                            </p>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
        </div><!--end container-->
            ...
            <div class="row align-items-center">
                <div class="col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="section-title me-lg-5">
                        ...
                        <p class="text-muted" style="text-align: justify">
                            تلفن همراه مانند اتومبیل و خانه پیوسته در معرض خطر آتش‌سوزی یا خطر افتادن در آب، و یا آسیب دیدن در زلزله است. شرکت <span class="text-primary fw-bold">پیدا سرویس ماندگار</span> تمام بلایای طبیعی را تحت پوشش قرار می‌دهد. پیدا سرویس در همه‌ی حوادث و<span class="text-warning"> #تاهمیشه</span> کنار شما خواهد ماند.                              </p>
    ...
    <section class="section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="{{URL::asset('main/images/hardware.png')}}" class="me-md-4" alt="">
                </div><!--end col-->
                ...
                <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="section-title ms-lg-5">
                        ...
                        <p class="text-muted" style="text-align: justify">
                            به اختلالاتی گفته می‌شود که به دلیل بروزشان، عملکرد بخش یا تمامی قسمت‌های یک تلفن همراه با مشکل مواجه می‌شود. سخت‌افزار قطعات فیزیکی و قابل لمس گوشی است. از مهم‌ترین قطعه‌های سخت‌افزاری تلفن همراه هوشمند می‌توان به صفحه نمایشگر، دوربین‌ها، بلندگوها، مودم‌ها، حافظه و ذخیره‌سازی، پردازنده تصویر و ویدئو، پردازنده گرافیکی، پردازنده مرکزی، آی‌سی‌ها و بردها اشاره کرد. چنان‌چه به مشکلات سخت‌افزاری برخوردید کار را به <span class="text-primary fw-bold">پیدا سرویس ماندگار </span> بسپارید.
                        </p>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
