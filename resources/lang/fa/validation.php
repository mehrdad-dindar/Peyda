...
return [
    ...
    'attributes' => [
        'day_other'=>'روز تولد مالک',
        'month_other'=>'ماه تولد مالک',
        'year_other'=>'سال تولد مالک',
        'price_range'=>'بازه قیمت تلفن همراه',
        'f_name' => 'نام',
        'f_name_other' => 'نام مالک',
        'melli_code_other'=>'کد ملی',
        'postal_code_other'=>'کد پستی مالک',
        'l_name' => 'نام خانوادگی',
        'l_name_other' => 'نام خانوادگی مالک',
        'city_id' => 'شهر',
        'city_id_other' => 'شهر مالک',
        'slider_img_url' => 'عکس اسلایدر',
        'slider_link' => 'لینک اسلایدر',
        'descriptions' => 'توضیحات',
        'melli_card' => 'کارت ملی',
        'postal_code' => 'کدپستی',
        'phone_brand_id' => 'برند گوشی',
        'phone_model_id' => 'مدل گوشی',
        'melli_card_back' => 'پشت کارت ملی',
        'birthday_tmp' => 'تاریخ تولد',
        'avatar' => 'آواتار',
        'address' => 'نشانی',
        'address_other' => 'نشانی مالک',
        'age' => 'سن',
        'area' => 'منطقه',
        'available' => 'موجود',
        'city' => 'شهر',
        ...
        'phone_num_other' => 'شماره همراه مالک',
        'month' => 'ماه',
        'name' => 'نام',
