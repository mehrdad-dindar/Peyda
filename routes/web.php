...
Route::prefix('panel')->group(function () {
    ...
    Route::prefix('warranty')->group(function () {
        Route::prefix('mobile')->group(function () {
            ...
            Route::get('/uploadPhoto/{id}',[MobileWarrantyController::class , 'uploadPhoto'])->name('uploadPhoto');
            Route::post('/insertPhoto/{mobile_warranty}/{edit?}',[MobileWarrantyController::class , 'insertPhotos'])->name('insertPhoto');
            Route::get('/editPhoto/{id}',[MobileWarrantyController::class , 'editPhoto'])->name('editPhoto');
            Route::post('/updatePhoto/{id}',[MobileWarrantyController::class , 'updatePhoto'])->name('updatePhoto');
            Route::get('/print/{id}',[MobileWarrantyController::class,'print'])->name('print');
            Route::get('/htmlPdf/{id}', [HTMLPDFController::class,'htmlPdf'])->name('htmlPdf');
        });
    });
